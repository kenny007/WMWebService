...
{
    public class WSAuthorizeAttribute:AuthorizationFilterAttribute
    {
        [Inject]
        public ServiceRepository TheRepository { get; set; }
            ...
            if (authHeader != null)
            {
                ...
                !String.IsNullOrWhiteSpace(authHeader.Parameter))
                {
                    ...
                    if (IsResourceOwner(userName, actionContext))
                    {
                        ...
                        if (TheRepository.LoginClient(userName, password))
                        {
        ...
        private bool IsResourceOwner(string userName, System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            var resourceUserName = "kennymore";
        ...
        private void HandleUnauthorizedRequest(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            "Basic Scheme='WaremanWS' location='http://localhost:30594/api/account/login'");
